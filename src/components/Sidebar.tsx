...
import { LayoutDashboard, Users, GraduationCap, BookOpen, Calendar, MessageSquare, Settings, LogOut, UserCog, DollarSign, ChevronUp, School } from 'lucide-react';
          ...
          <SidebarGroupContent>
            <SidebarMenu>
              {items.map(item => <SidebarMenuItem key={item.title}>
                  ...
                  isActive
                }) => `flex items-center gap-3 px-3 py-2 rounded-lg transition-all duration-200 ${isActive ? 'bg-gradient-primary text-primary-foreground shadow-card' : 'hover:bg-muted/50 text-foreground'}`}>
